    ...
    <body>
        ...
        <div class="container">
            <div class="row visible-xs">
                <?php include 'main-menu/main-menu-xs.php' ?>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-7 col-md-8">
                    <h3  id="set9-1" class="well well-sm " style="background-color:#0b7dda; color: #ffffff; margin-bottom: 5px"><?php echo $header_name1 ?></h3>
                    <div class="panel-group" id="kpruita">
                        ...
                        <?php include 'ita-dataita-17-data-noactive.php' ?>
